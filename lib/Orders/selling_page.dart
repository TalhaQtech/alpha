...
class SellingPage extends StatefulWidget {
  ...
  @override
  State<SellingPage> createState() => SellingPageState();
}
        ...
        child: sortedList.isEmpty
            ?  Column(
              ...
              children: [
                  ...
                  topMargin(10),
                  Text("You do not have any selling history at the moment")
                ])
                                  ...
                                  child: TextButton(
                                      onPressed: () {
                                        showCancelBlurryDialog(
                                            ...
                                            "$sellerName has just canceled this order. Thank you.");
                                      },
                                      child: Text(
                                        "Cancel Order",
